...
import { Moon, Sun, LogOut, Heart, Menu } from "lucide-react";
...
export function Navbar({ onToggleSidebar }: { onToggleSidebar?: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-black/5 bg-white/95 backdrop-blur-md dark:border-white/10 dark:bg-[#0f0f0f]/95 px-3 py-2 md:px-6">
