...
function YtLikeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
      <path d="M18.77 11h-4.23l1.52-4.94C16.38 5.03 15.54 4 14.38 4c-.58 0-1.14.24-1.52.65L7 11H3v10h4h1h9.43c1.06 0 1.98-.67 2.19-1.61l1.34-6c.27-1.22-.56-2.39-1.84-2.39zM7 20H4v-8h3v8zm13.14-5.56l-1.34 6c-.07.31-.38.56-.74.56H8v-9.44l5.53-6.03c.12-.13.3-.2.48-.2.27 0 .54.15.65.41.05.11.08.26.04.47l-1.74 5.64H18.77c.42 0 .79.23.95.61.16.37.09.81-.19 1.13z" />
    </svg>
  );
}
