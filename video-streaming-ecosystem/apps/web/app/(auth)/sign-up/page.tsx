              ...
              {step === 1 && (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="mt-5 flex w-full items-center justify-center gap-3 rounded-2xl border border-neutral-200 bg-white py-3 text-xs font-semibold text-neutral-700 shadow-sm transition hover:bg-neutral-50 dark:border-white/10 dark:bg-white/10 dark:text-white dark:hover:bg-white/15 disabled:opacity-50"
                  >
                  ...
                  <div className="my-5 flex items-center gap-3">
                    ...
                    <span className="text-[11px] font-medium text-neutral-400">OR REGISTER WITH EMAIL</span>
                    <div className="h-px flex-1 bg-neutral-200 dark:bg-white/10" />
                  </div>
